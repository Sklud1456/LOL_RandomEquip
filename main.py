...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.pushButton.setGeometry(QtCore.QRect(660, 400, 111, 51))
        self.pushButton.setIconSize(QtCore.QSize(30, 30))
        self.pushButton.setObjectName("pushButton")
        self.pushButton.clicked.connect(self.generate_equip)

        self.frame_4 = QtWidgets.QLabel(self)
        self.frame_4.setGeometry(QtCore.QRect(175, 250, 38, 16))
        ...
        self.Equip_3.setGeometry(QtCore.QRect(530, 180, 38, 16))
        ...
        self.Equip_1.setGeometry(QtCore.QRect(30, 180, 38, 16))
        ...
        self.Equip_4.setGeometry(QtCore.QRect(150, 400, 38, 16))
        ...
        self.Equip_2.setGeometry(QtCore.QRect(280, 180, 38, 16))
    ...
    def GenerateEquipList(self):
        ...
        with open(file_path, "r", encoding="utf-8") as file:
            for line in file:
                # 处理每一行的内容
                EquipList.append(line.strip())
        number = len(EquipList)
        random_selection = random.sample(EquipList, 5)
        result=""
        for e in random_selection:
            result+=e+"、"
